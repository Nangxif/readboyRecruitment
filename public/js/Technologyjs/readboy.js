$(function(){
	$(".startPage").css("height",$(window).height()+"px");
	$(".item,.company").css("height",$(window).height()+"px");
	var getPeople=[
		{
			"category":"技术类",
	...
	for(var m=0;m<getPeoplelength;m++){
		var item=$("<div class='item item-"+(2+m)+"'></div>");
	...
	$.getScript("/public/js/Technologyjs/iSlider.js", function() {
	    new iSlider();
	    $(".startPage").on("click",function(){
			$(".chilun").addClass('change');
			$(".startPage").delay(2000).animate({"top":"-"+$(window).height()+"px"},1000,function(){
				$(".index>.index-1").animate({"left":"0rem"},500);
				$(".index>.index-2").delay(100).animate({"left":"0rem"},500);
				$(".index>.index-3").delay(200).animate({"left":"0rem"},500);
				$(".index>.index-4").delay(400).animate({"left":"0rem"},500);
			});
		});
		$(".index>.index-1").on("touchstart",function(){
			$(".index>.index-1").animate({"left":"-7rem"},500);
			$(".index>.index-2").delay(100).animate({"left":"-7rem"},500);
			$(".index>.index-3").delay(200).animate({"left":"-7rem"},500);
			$(".index>.index-4").delay(400).animate({"left":"-7rem"},500);
			$(".company").animate({"left":"0","opacity":"1"},900);
		})
		$(".company").on("touchstart",function(){
			$(".company").animate({"left":"7.5rem","opacity":"0"},900);
			$(".index>.index-1").animate({"left":"0rem"},500);
			$(".index>.index-2").delay(100).animate({"left":"0rem"},500);
			$(".index>.index-3").delay(200).animate({"left":"0rem"},500);
			$(".index>.index-4").delay(400).animate({"left":"0rem"},500);
		})
		$(".index>.index-2").on("touchstart",function(){
			$(".index>.index-1").animate({"left":"-7rem"},500);
			$(".index>.index-2").delay(100).animate({"left":"-7rem"},500);
			$(".index>.index-3").delay(200).animate({"left":"-7rem"},500);
			$(".index>.index-4").delay(400).animate({"left":"-7rem"},500,function(){
				$(".index").fadeOut();
				$(".det").fadeIn();
			});
		})
...
//     });
    ...
    $("#view").contents().find(".wrap").on("mouseover",function(){
        scrollFunc();
    })
